  ...
  if (onoff4) {
    ...
    t45
      ...
      .staggerTo(zboMon, 1, {
        cycle: {
          bezier: function() {
            return [{ x: -3 * fs, y: -2 * fs }, { x: -5 * fs, y: -1.3 * fs }];
          }
        }
      })
    ...
    t54
      ...
      .staggerTo(
        ...
        1,
        {
          cycle: {
            bezier: function() {
              return [{ x: -2 * fs, y: -2 * fs }, { x: -3 * fs, y: -1 * fs }];
            }
          }
        },
        '+=1'
  ...
  if (onoff7) {
    ...
    t71
      ...
      .staggerTo(zmaMon, 1, {
        cycle: {
          bezier: function() {
            return [{ x: -2 * fs, y: -2 * fs }, { x: -3.5 * fs, y: -0.3 * fs }];
          }
        }
      })
      .to(zmaMon, 0, {
  ...
  if (onoff9) {
    ...
    t91
      ...
      .staggerTo(zbaMon, 1, {
        cycle: {
          bezier: function() {
            return [{ x: -2 * fs, y: -1 * fs }, { x: -3 * fs, y: 0.3 * fs }];
          }
        }
      })
      .to(zbaMon, 0, {
...
function shakeShake() {
  ...
  if (onoff11) {
    onoff11 = false;
    // 摇手机
    t111.to(yaoyiyao, 0.5, { rotation: 10 }).to(yaoyiyao, 0.5, { rotation: 0 });
    t111.repeat(-1);
  } else {
    t111.restart();
  }
